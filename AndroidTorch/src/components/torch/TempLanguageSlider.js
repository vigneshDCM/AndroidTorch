...
const TempLanguageSlider = (props) => {
    ...
    useEffect(() => {
        ...
        console.log('dim height...', deviceHeight - SAFE_VIEW_HEIGHT)
    ...
    return (
        ...
        //   //  onDragEnd={(data) => {
        //         if (data == deviceHeight - SAFE_VIEW_HEIGHT) {
        ...
        >
             {(dragHandlers) => <SlideUpRender dragHandlers={dragHandlers}/>}
...
export const SlideUpRender = ({dragHandlers}) => {
    ...
    return (<View style={{
        ...
        <View style={styles.languageListContainer} >
            ...
            <ScrollView style={{ width: '100%' }} onScroll={onScroll}
                onScrollEndDrag={() => console.log('endddd')}
...
export default TempLanguageSlider